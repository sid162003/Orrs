                        ...
                        <tbody>
                            <?php 
                                ...
                                if(!empty($date) && !empty($time)){
                                    $swhere = " and ((`type` = 1 and time(time_schedule) BETWEEN '".(date('H:i',strtotime($date." ".$time." -1 hours")))."' and '".(date('H:i',strtotime($date." ".$time." +1 hours")))."' ) or (`type` = 1 and date(date_schedule) = '{$date}' and time(time_schedule) BETWEEN '".(date('H:i',strtotime($date." ".$time." -1 hours")))."' and '".(date('H:i',strtotime($date." ".$time." +1 hours")))."' ))" ;
                                }
                                $i = 1;
